...
class CuMatrixBase {
 public:
  ...
  /// Only supports the case when transB = kTrans; will crash if transB = kNoTrans
  void AddMatSmat(Real alpha, const CuMatrixBase<Real> &A, MatrixTransposeType transA,
