...
#include "nnet3/nnet-combine-multi.h"
...
void NnetCombinerMulti::ComputeUpdatableComponentDims(){
...
void NnetCombinerMulti::AcceptNnet(const Nnet &nnet) {
...
void NnetCombinerMulti::FinishPreprocessingInput() {
  KALDI_ASSERT(num_nnets_provided_ == num_real_input_nnets_ &&
...
void NnetCombinerMulti::Combine() {
...
void NnetCombinerMulti::PrintParams(const VectorBase<BaseFloat> &params) const {
...
bool NnetCombinerMulti::SelfTestDerivatives() {
...
void NnetCombinerMulti::SelfTestModelDerivatives() {
...
int32 NnetCombinerMulti::ParameterDim() const {
  if (config_.separate_weights_per_component)
...
void NnetCombinerMulti::GetInitialParameters(VectorBase<BaseFloat> *params) const {
...
void NnetCombinerMulti::GetWeights(const VectorBase<BaseFloat> &params,
...
void NnetCombinerMulti::GetParamsDeriv(const VectorBase<BaseFloat> &weights,
...
void NnetCombinerMulti::GetNnetParameters(const Vector<BaseFloat> &weights,
...
void NnetCombinerMulti::GetWeightsDeriv(
...
double NnetCombinerMulti::ComputeObjfAndDerivFromNnet(
...
double NnetCombinerMulti::ComputeObjfAndDerivFromParameters(
...
void NnetCombinerMulti::GetNormalizedWeights(
...
void NnetCombinerMulti::GetUnnormalizedWeightsDeriv(
    const VectorBase<BaseFloat> &unnorm_weights,
