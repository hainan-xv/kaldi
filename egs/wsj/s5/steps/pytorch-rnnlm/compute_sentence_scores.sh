...
#/home/tongfei/app/anaconda/bin/python -u steps/pytorch-rnnlm/rnnlm_eval.py --MODEL $dir/final.mdl --TEST $tempdir/text.txt | grep sentence | awk '{print $NF}' > $tempdir/loglikes.rnn
echo "/home/tongfei/app/anaconda/bin/python -u steps/pytorch-rnnlm/rnnlm_eval.py --MODEL data/pytorch-lm-2/tmp.12.mdl --TEST $tempdir/text.txt --VOCAB data/pytorch-lm-2/vocab.txt | grep score | awk '{print \$4}' > $tempdir/loglikes.rnn"
/home/tongfei/app/anaconda/bin/python -u steps/pytorch-rnnlm/rnnlm_eval.py --MODEL data/pytorch-lm-2/epoch.8.mdl --TEST $tempdir/text.txt --VOCAB data/pytorch-lm-2/vocab.txt | grep score | awk '{print $4}' > $tempdir/loglikes.rnn
