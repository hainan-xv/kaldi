...
import sys
sys.path.insert(0, "/export/b08/dgao/kaldi/tools/tensorflow_build/.local/lib/python2.7/site-packages/")
import inspect
import time
...
class RnnlmModel(object):
  ...
  def __init__(self, is_training, config, input_):
    ...
    test_logits = tf.diag_part(tf.matmul(cellout_placeholder, this_softmax_w)) + this_softmax_b
