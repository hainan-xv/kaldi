...
/home/tongfei/app/anaconda/bin/python -u steps/pytorch-rnnlm-2/rnnlm_eval.py --MODEL data/new-pytorch/best.mdl --TEST $tempdir/text.txt --VOCAB data/pytorch-lm-2/vocab.txt | grep score | awk '{print $4}' > $tempdir/loglikes.rnn
