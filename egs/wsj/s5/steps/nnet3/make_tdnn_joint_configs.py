...
total_leaves = args.num_leaves_total
sparse_mat = args.sparse_matrix
num_virtual_leaves = args.num_targets

print('# matrix is ' + sparse_mat)
print('# leaves is ' + str(total_leaves))
print('# leaves is ' + str(num_virtual_leaves))
